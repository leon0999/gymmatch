            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-3 gap-3">
                    {[
                      ...
                      { key: 'maintain', label: 'Maintain', desc: 'Stay fit' },
                      { key: 'strength', label: 'Strength', desc: 'Get stronger' },
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="block text-xs text-gray-600 mb-1 font-medium">Bench Press</label>
                      <input
                        type="number"
                ...
                <div>
                  ...
                  <div className="flex flex-col items-center gap-4">
                    ...
                    {formData.photoUrl ? (
                      ...
                      <div className="w-40 h-40 rounded-full bg-gradient-to-br from-gray-100 to-gray-200 border-4 border-dashed border-gray-400 flex items-center justify-center">
